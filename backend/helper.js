...
const comparePassword = (currentpassword, bodypassword) => {
...
const returnFunction = (statusData, responseMsg, responseData) => {
...
const uploadFileAzure = async (filePath, lclbookingId, fileNamePath) => {
...
const { ShareServiceClient } = require("@azure/storage-file-share");
var CONFIG1 = require('../../config/config.json')
const downloadFileAzure = async (lclbookingId) => {
  let serviceClient, shareName, shareClient, shareExists,
